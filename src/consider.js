...
const BANDS = [
  {
    ...
    regions: [
      {
        color: "Green",
        text: "looks like a reasonably safe opponent",
        match: le(-4),
      },
      {
        color: "Blue",
        text: "looks like you would have the upper hand",
        match: between(-3, -1),
      },
      { color: "White", text: "looks like an even fight", match: eq(0) },
      {
        color: "Yellow",
        text: "looks like quite a gamble",
        match: between(1, 2),
      },
      {
        color: "Red",
        text: "what would you like your tombstone to say?",
        match: ge(3),
      },
    ],
  },
  {
    ...
    regions: [
      ...
      {
        color: "Blue",
        text: "looks kind of risky, but you might win.",
        match: between(-3, -1),
      },
      {
        color: "White",
        text: "looks kind of risky..you might win.",
        match: eq(0),
      },
      {
        color: "Yellow",
  ...
  },
  {
    ...
    regions: [
      {
        color: "Green",
        text: "You would probably win this fight..it's not certain though.",
        match: between(-7, -6),
      },
      {
        color: "Green",
      ...
      {
        color: "Blue",
        text: "looks quite risky, but might be worth a try.",
        match: between(-5, -3),
      },
      {
        color: "Blue",
        text: "looks kind of dangerous.",
        match: between(-2, -1),
      },
  ...
  },
  {
    ...
    regions: [
      ...
      {
        color: "Green",
        text: "This creature could pose problems, you would probably defeat it.",
        match: eq(-10),
      },
      {
        color: "Green",
        text: "You could probably win this fight.",
        match: le(-11),
      },
      {
        color: "Blue",
        text: "appears to be quite formidable.",
        match: between(-7, -1),
      },
      { color: "White", text: "looks like quite a gamble.", match: eq(0) },
      {
        color: "Yellow",
        text: "looks like it would wipe the floor with you!",
        match: between(1, 2),
      },
      {
        color: "Red",
