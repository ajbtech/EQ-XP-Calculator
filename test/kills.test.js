...
test("kills track each player's own remaining XP and share", () => {
  ...
  // total = 3^2 * 75 * 1.02 = 688.5; shares are by cumulative XP to next level:
  // L2 xpToNext 8000, L3 xpToNext 27000 -> 8/35 and 27/35.
  // L2: xp 157.37 -> ceil(7000/157.37) = 45.
  // L3: xp 531.13 -> ceil(19000/531.13) = 36.
